    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl selection:bg-blue-500/30">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <Card className="bg-gray-900 border-gray-800 shadow-2xl overflow-hidden">
            <div className="p-8 border-l-4 border-blue-600 bg-gradient-to-r from-blue-900/10 to-transparent">
              ...
              {/* Game Mode Title Header */}
              <div className="text-center mb-6">
                <div className="text-xs uppercase tracking-[0.3em] text-blue-500 font-black">
                  {gameData?.name || 'Exhibition'}
                </div>
              </div>

              {/* Match Versus Layout Grid */}
              <div className="flex flex-col sm:flex-row justify-between items-center py-4 gap-6">
                ...
                <div className="flex flex-col items-center gap-3 flex-1 text-center">
                  ...
                  <span className="text-[10px] text-blue-400 font-mono tracking-widest uppercase font-bold">Player 1</span>
                </div>

                {/* Mid VS Divider Layout */}
                <div className="flex flex-col items-center justify-center px-4">
                  <span className="text-4xl font-black text-gray-700 italic tracking-tighter select-none">VS</span>
                  <div className="h-px w-16 bg-gray-800 mt-2"></div>
                </div>
                ...
                <div className="flex flex-col items-center gap-3 flex-1 text-center">
                  ...
                  <span className="text-[10px] text-blue-400 font-mono tracking-widest uppercase font-bold">Player 2</span>
                </div>
        ...
        <aside className="space-y-6">
          <div className="rounded-2xl bg-[#0a0a0c] border border-gray-800 p-4 text-sm text-gray-400 leading-relaxed">
            {supportsInPerson ? (
              <>
